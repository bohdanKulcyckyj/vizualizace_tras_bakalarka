...
export const simplifyBase = <T>(
  getSquareDistance: (point1: T, point2: T) => number,
  getSquareSegmentDistance: (point1: T, point2: T, point3: T) => number,
) => {
 ...
 * @return {Number}
 */
function getSquareDistance(p1: IPoint3D, p2: IPoint3D) {
  // square distance between 2 points
 ...
 * @return {Number}
 */
function getSquareSegmentDistance(p: IPoint3D, p1: IPoint3D, p2: IPoint3D) {
  // square distance from a point to a segment
...
export const simplify3D = simplifyBase(
  getSquareDistance,
