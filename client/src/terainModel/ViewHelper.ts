...
class ViewHelper extends Object3D {
	...
	constructor(camera: Camera, domElement: HTMLElement) {
		...
		function prepareAnimationData(object: Object3D<Event>, focusPoint: Vector3) {
		...
		function getSpriteMaterial(color: Color, text: string = null) {
